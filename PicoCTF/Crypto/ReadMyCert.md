...
## Solución
```bash
kali@KaliEND:~/Downloads/PicoCTF/Act20$ wget https://artifacts.picoctf.net/c/420/readmycert.csr  
--2026-04-22 11:48:22--  https://artifacts.picoctf.net/c/420/readmycert.csr  
...
2026-04-22 11:48:31 (13,0 MB/s) - «readmycert.csr» guardado [997/997]  
  
kali@KaliEND:~/Downloads/PicoCTF/Act20$ ls  
atbash.jpg  bin  encrypted.txt  flag.png  message.txt  readmycert.csr  scrambled1.png  scrambled2.png  script.py  values  
kali@KaliEND:~/Downloads/PicoCTF/Act20$ cat readmycert.csr    
...
kali@KaliEND:~/Downloads/PicoCTF/Act20$  openssl req -text -noout -verify -in readmycert.csr    
...
```
## Notas Adicionales
obtuvimos un certificado csr, entonces buscamos la manera de decodificarla y al momento de hacerlo ahí encontramos la flag:

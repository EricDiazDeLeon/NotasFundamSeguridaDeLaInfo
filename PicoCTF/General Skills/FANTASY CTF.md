## Objetivo
Play this short game to get familiar with terminal applications and some of the most important rules in scope for picoCTF. Connect to the program with netcat: `$ nc verbal-sleep.picoctf.net 52906`
## Solución
```bash
ericdiazdeleon@2806-103e-0013-33e9-b535-6a1f-5403-1770:/var/home/ericdiazdeleon/Documentos/Tareas/NotasFundamSeguridaDeLaInfo$ nc verbal-sleep.picoctf.net 52906
...
"Thanks, Nyx! Here's the flag I found: picoCTF{m1113n1um_3d1710n_2d78cdd9}"
...
```
## Notas Adicionales
En este reto teníamos que jugar un 'juego' mediante el netcat probando las diferentes opciones hasta llegar a la solución correcta.
